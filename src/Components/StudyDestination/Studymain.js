...
const Studymain = () => {
  ...
  return (
    <div className='studymain'>
        <div data-aos="fade-up" data-aos-easing="ease-in-out" className='University3'>
        ...
        <div  data-aos="fade-up" data-aos-easing="ease-in-out" className='TestPreparation3'>
        <div className='studycontent'>
        ...
        <div  data-aos="fade-up" data-aos-easing="ease-in-out"  className='soplor3'>
        <div className='studycontent'>
        ...
        <div  data-aos="fade-up" data-aos-easing="ease-in-out" className='educationloans3'>
        <div className='studycontent'>
        ...
        <div  data-aos="fade-up" data-aos-easing="ease-in-out" className='visaprocess3'>
        <div className='studycontent'>
        ...
        <div  data-aos="fade-up" data-aos-easing="ease-in-out"  className='foreignlang3'>
        <div className='studycontent'>
        ...
        <div  data-aos="fade-up" data-aos-easing="ease-in-out" className='visaprocess4'>
        <div className='studycontent'>
        ...
        <div  data-aos="fade-up" data-aos-easing="ease-in-out"  className='foreignlang4'>
        <div className='studycontent'>
